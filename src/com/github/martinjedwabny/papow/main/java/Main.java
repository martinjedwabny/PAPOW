package com.github.martinjedwabny.papow.main.java;
...
import com.github.martinjedwabny.papow.main.java.io.reader.SessionCommandReader;
...
public class Main {
	 ...
	 * 
	 * 	Example :
	 * 		-f src/com/github/martinjedwabny/papow/main/json/sample.json -v [pb,fb,k2] -c [[(Color,Red),(Country,France)]]
	 * 
	 * @param args
	 * @throws Exception
	 */
